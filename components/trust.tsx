          ...
          <ul className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2">
            {checklist.map((item) => (
              <li key={item} className="flex items-start gap-3 text-sm text-ink/80">
                <span className="mt-0.5 text-brass" aria-hidden="true">✓</span>
                {item}
              </li>
            ))}
          </ul>

          <p className="mt-8 rounded-xl bg-linen-dark px-5 py-4 text-sm leading-relaxed text-ink/70">
            <strong className="text-ink">Not sure you&rsquo;re talking to us?</strong>{" "}
        ...
        <div className="flex justify-center md:justify-end">
          <div className="stamp-badge">
            <svg viewBox="0 0 100 100" aria-hidden="true">
              ...
              <text className="fill-brass" fontSize="8.2" letterSpacing="2" fontFamily="var(--font-plex-mono)">
