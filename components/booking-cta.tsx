        ...
        <div className="grid grid-cols-1 gap-6 p-7 sm:grid-cols-3 sm:p-8">
          <label className="block">
            ...
            <input
              ...
              className="mt-2 w-full rounded-lg border border-ink/15 bg-transparent px-3 py-2 font-mono text-sm text-ink"
            />
          </label>
          <label className="block">
        ...
        <div className="flex flex-col gap-4 p-7 sm:flex-row sm:items-center sm:justify-between sm:p-8">
          <label className="block w-full sm:max-w-[220px]">
            ...
            <input
              ...
              className="mt-2 w-full rounded-lg border border-ink/15 bg-transparent px-3 py-2 text-sm text-ink placeholder:text-ink/30"
            />
          </label>
          <button
            type="submit"
            className="w-full shrink-0 rounded-full bg-ink px-6 py-3 text-sm font-medium text-linen transition-colors hover:bg-azure sm:w-auto"
          >
            Send Inquiry
          </button>
        </div>
