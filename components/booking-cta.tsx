  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl px-5">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <label className="block min-w-0">
              ...
              <input
                ...
                className="mt-2 block w-full min-w-0 rounded-xl border border-ink/15 bg-linen px-3 py-2.5 text-sm text-ink placeholder:text-ink/30 outline-none transition-colors focus:border-brass"
              />
            </label>
          </div>
        ...
        {/* Direct contact */}
        <div className="mt-4 flex flex-col flex-wrap items-center justify-center gap-2 text-center sm:flex-row sm:gap-3">
