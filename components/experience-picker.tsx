    ...
    <section className="mx-auto max-w-6xl px-5 py-20 sm:py-28">
      ...
      <div className="mt-10 grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-5">
        {reasons.map((r) => (
          <div
            key={r.label}
            className="group flex flex-col justify-between rounded-2xl border border-ink/8 bg-cloud p-5 shadow-card transition-transform duration-300 hover:-translate-y-1"
          >
            ...
            <div className="mt-6">
              ...
              <p className="mt-1 text-xs leading-snug text-ink/55">{r.detail}</p>
            </div>
          </div>
        ))}
      </div>
